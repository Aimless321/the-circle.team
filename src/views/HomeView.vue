      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="relative sm:overflow-hidden sm:rounded-2xl">
          ...
          <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
            ...
            >
              A gaming community primarily focused on competitive Hell Let
              Loose.
            </p>
            <div
      ...
      >
        <div class="relative pt-12">
          ...
          <p class="mt-5 text-lg text-gray-300">
            We are a relatively new community est. 2022 with the goal of
            creating an inclusive gaming community where everyone can feel
            welcomed and relocate the "fun" we so often lose when we try and
        ...
        <div class="relative pt-12">
          ...
          <p class="mt-5 text-lg text-gray-300 mb-4">
            ...
            week to play Hell Let Loose in a more coordinated and more
            competitive way.
          </p>
            ...
            <div>
              ...
              <div class="mt-6">
                <p class="mt-4 text-lg text-gray-400">
                  We run two public servers which are seeded daily. We have a
                  lot of active server moderators which enforce the rules and
                  keep our servers clean. As a member you will get a VIP slot on
                  all of our servers.
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            <div>
              ...
              <div class="mt-6">
                <p class="mt-4 text-lg text-gray-400">
                  Even though we're mainly focused on Hell Let Loose, there are
                  a lot of different games that are being discussed and played
                  on our discord.
                </p>
              </div>
            </div>
